...
_Generated: 2026-04-02T00:41:08.925Z_
...
Workspace `mcp.json` _(folder: iswebsitedown)_

- **d:\AI PROJECTS\VSCODEPROJECTS\iswebsitedown\.vscode\mcp.json** — _File missing_
...
- **skill-creator** — `C:\Users\Mahen\.claude\skills\skill-creator`
